...
[![Version](https://img.shields.io/github/release-pre/phin1x/go-ipp.svg)](https://github.com/hiventive/go-ipp/releases/tag/v1.5.1)
...
```
go get -u github.com/hiventive/go-ipp
```
